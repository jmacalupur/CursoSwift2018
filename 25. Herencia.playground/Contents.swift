...
me.account?.addTransaction(transaction: Debit(value: 20, name: "Cafe con amigos"))
me.account?.addTransaction(transaction: Debit(value: 100, name: "Juego de Nintendo Switch"))
me.account?.addTransaction(transaction: Debit(value: 1200, name: "Nintendo Switch"))
me.account?.addTransaction(transaction: Gain(value: 2000, name: "Salario"))
