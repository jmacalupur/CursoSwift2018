...
me.account?.addTransaction(transaction: .debit(Debit(value: 20, name: "Cafe con amigos", category: DebitCategories.food)))
me.account?.addTransaction(transaction: .debit(Debit(value: 100, name: "Juego de Nintendo Switch", category: .entertainment)))
me.account?.addTransaction(transaction: .debit(Debit(value: 1200, name: "Nintendo Switch", category: .entertainment)))

me.account?.addTransaction(
    transaction: .gain(Gain(value: 2000, name: "Salario", category: .salary)))
